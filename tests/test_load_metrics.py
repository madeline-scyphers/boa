from optiwrap import setup_synthetic_metric, get_metric_by_class_name, get_metric_from_config
...
def test_load_metric_from_config(optimization_options):
    metric = get_metric_from_config(optimization_options["metric"])()
